export default function Steps() {
  return (
    <>
      <div 
        className="container mx-auto py-20 px-3 md:px-0"
        data-aos="fade-up" 
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-14 py-8">
          <div className="bg-primary text-tertiary text-center rounded-2xl border-tertiary w-full p-2 md:p-4 flex flex-col gap-3 items-center cursor-pointer hover:scale-105 transition-all">
          ...
          <div className="bg-primary text-tertiary text-center rounded-2xl border-tertiary w-full p-2 md:p-4 flex flex-col gap-3 items-center cursor-pointer hover:scale-105 transition-all">
            ...
            <p className="text-sm md:text-lg">
              ...
              NFTs with properties, stars, and unlockable content.
            </p>
          </div>
          <div className="bg-primary text-tertiary text-center rounded-2xl border-tertiary w-full p-2 md:p-4 flex flex-col gap-3 items-center cursor-pointer hover:scale-105 transition-all col-span-2 md:col-span-1">
